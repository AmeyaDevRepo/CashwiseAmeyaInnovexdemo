    ...
    >
      <div className=" text-center p-8  ">
        ...
        >
          ...
          <h2 className="text-xl font-semibold text-blue-900 dark:text-blue-200 mt-4">
            Oops! Page Not Found
          </h2>
        </motion.div>
        ...
        >
          <Link
            href="/"
            className="inline-block px-8 py-3 mt-4 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-700"
          >
            Return to Home
          </Link>
        </motion.div>
