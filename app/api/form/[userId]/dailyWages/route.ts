...
export async function POST(
 ...
 const expenseDateValue = body.get("expenseDate") as string | null;
    ...
    // data object
    const dailyWagesData = {
      siteName: body.get("siteName"),
      todayWork: body.get("todayWork"),
      location: body.get("location"),
      amount,
      purposeOfLabour: body.get("purposeOfLabour"),
      masterLabourName: body.get("masterLabourName"),
      masterLabourNumber: body.get("masterLabourNumber"),
      numberOfLabours: body.get("numberOfLabour"),
    ...
    if (schemaName === "/officeExpense") {
      result = await OfficeExpense.findOneAndUpdate(
        ...
        { $push: { dailyWages: dailyWagesData } },
        {
          upsert: true,
          new: true,
          runValidators: true,
